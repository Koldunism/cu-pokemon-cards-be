...
export class HttpResponse {
  ...
  public async unauthorized(res: FastifyReply, message?: string | HttpErrorRes): Promise<any> {
    return this.jsonResponse(res, 401, { code: STATUS_CODES[401], message })
  }
  public async forbidden(res: FastifyReply, message?: string | HttpErrorRes): Promise<any> {
    return this.jsonResponse(res, 403, { code: STATUS_CODES[403], message })
  }
  public async notFound(res: FastifyReply, message?: string | HttpErrorRes): Promise<any> {
